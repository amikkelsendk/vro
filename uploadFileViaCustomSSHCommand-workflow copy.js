...
.INPUTS
  ...
  strUsername (string)
  strTargetHostDirPath (string)
  strTargetFileName (string)
  strvCOSourceFilePath (string)
  sshCommand (string)
.OUTPUTS
...
var destFilename = strTargetFileName
var destFile = strTargetHostDirPath + "/" + destFilename
var session = null;
var port = 22;
var keyPath = null;
...
try {
	...
	if (strvCOSourceFilePath) {
		System.log("Transfering file")
		if (session.putFile(strvCOSourceFilePath, strTargetHostDirPath) != 0) {
			throw "Failed to transfer file."
		}
	}
